...
all_elements = {
    '01H': {'name': '氢', 'symbol': 'H', 'atomicNumber': 1, 'category': '非金属', 'group': 1, 'period': 1,
            ...
            'hazardClass': '易燃气体', 'casNumber': '1333-74-0', 'description': '氢是宇宙中最轻、最丰富的元素，约占宇宙质量的75%。它是一种无色、无味、无臭的气体。',
    ...
    '04Be': {'name': '铍', 'symbol': 'Be', 'atomicNumber': 4, 'category': '碱土金属', 'group': 2, 'period': 2,
             ...
             'hazardClass': '致癌物', 'casNumber': '7440-41-7', 'description': '铍是一种轻质、坚硬的灰色金属，具有高熔点。',
    ...
    '05B': {'name': '硼', 'symbol': 'B', 'atomicNumber': 5, 'category': '类金属', 'group': 13, 'period': 2,
            ...
            'hazardClass': '刺激性', 'casNumber': '7440-42-8', 'description': '硼是一种非金属元素，通常以无定形或结晶形式存在。',
    ...
    '06C': {'name': '碳', 'symbol': 'C', 'atomicNumber': 6, 'category': '非金属', 'group': 14, 'period': 2,
            ...
            'hazardClass': '可燃', 'casNumber': '7440-44-0', 'description': '碳是地球上所有生命的基础，以多种同素异形体存在。',
    ...
    '07N': {'name': '氮', 'symbol': 'N', 'atomicNumber': 7, 'category': '非金属', 'group': 15, 'period': 2,
            ...
            'hazardClass': '非易燃气体', 'casNumber': '7727-37-9', 'description': '氮是大气中最丰富的元素，约占空气体积的78%。',
    ...
    '08O': {'name': '氧', 'symbol': 'O', 'atomicNumber': 8, 'category': '非金属', 'group': 16, 'period': 2,
            ...
            'discoverer': '约瑟夫·普利斯特里', 'discoveryYear': '1774', 'uses': '呼吸、燃烧、炼钢、医疗',
    ...
    '09F': {'name': '氟', 'symbol': 'F', 'atomicNumber': 9, 'category': '卤素', 'group': 17, 'period': 2,
            ...
            'hazardClass': '强氧化剂', 'casNumber': '7782-41-4', 'description': '氟是最活泼的非金属元素，能与几乎所有元素反应。',
    ...
    '10Ne': {'name': '氖', 'symbol': 'Ne', 'atomicNumber': 10, 'category': '稀有气体', 'group': 18, 'period': 2,
             ...
             'discoverer': '威廉·拉姆齐', 'discoveryYear': '1898', 'uses': '霓虹灯、激光、低温研究',
             'hazardClass': '非易燃气体', 'casNumber': '7440-01-9', 'description': '氖是一种惰性气体，在空气中含量稀少。',
    ...
    '11Na': {'name': '钠', 'symbol': 'Na', 'atomicNumber': 11, 'category': '碱金属', 'group': 1, 'period': 3,
             ...
             'hazardClass': '遇水反应', 'casNumber': '7440-23-5', 'description': '钠是一种银白色金属，在空气中容易氧化。',
    ...
    '12Mg': {'name': '镁', 'symbol': 'Mg', 'atomicNumber': 12, 'category': '碱土金属', 'group': 2, 'period': 3,
             ...
             'discoverer': '汉弗莱·戴维', 'discoveryYear': '1808', 'uses': '铝合金、烟火、医疗',
             'hazardClass': '可燃', 'casNumber': '7439-95-4', 'description': '镁是一种轻质银白色金属，燃烧时发出明亮的白光。',
    ...
    '13Al': {'name': '铝', 'symbol': 'Al', 'atomicNumber': 13, 'category': '金属', 'group': 13, 'period': 3,
             ...
             'discoverer': '汉斯·奥斯特', 'discoveryYear': '1825', 'uses': '建筑材料、航空航天、包装',
             'hazardClass': '无特殊危害', 'casNumber': '7429-90-5', 'description': '铝是地球上最丰富的金属元素，广泛用于各种工业领域。',
    ...
    '14Si': {'name': '硅', 'symbol': 'Si', 'atomicNumber': 14, 'category': '类金属', 'group': 14, 'period': 3,
             ...
             'discoverer': '永斯·贝采利乌斯', 'discoveryYear': '1823', 'uses': '半导体、玻璃、陶瓷',
             'hazardClass': '无特殊危害', 'casNumber': '7440-21-3', 'description': '硅是地壳中第二丰富的元素，是半导体工业的基础。',
    ...
    '15P': {'name': '磷', 'symbol': 'P', 'atomicNumber': 15, 'category': '非金属', 'group': 15, 'period': 3,
            ...
            'discoverer': '亨尼格·布兰德', 'discoveryYear': '1669', 'uses': '肥料、火柴、制药',
            'hazardClass': '易燃', 'casNumber': '7723-14-0', 'description': '磷是生命必需的元素，存在于DNA和细胞膜中。',
    ...
    '16S': {'name': '硫', 'symbol': 'S', 'atomicNumber': 16, 'category': '非金属', 'group': 16, 'period': 3,
            ...
            'discoverer': '已知元素', 'discoveryYear': '古代', 'uses': '硫酸生产、橡胶硫化、防腐剂',
            'hazardClass': '可燃', 'casNumber': '7704-34-9', 'description': '硫是一种黄色固体，具有刺激性气味。',
    ...
    '17Cl': {'name': '氯', 'symbol': 'Cl', 'atomicNumber': 17, 'category': '卤素', 'group': 17, 'period': 3,
             ...
             'discoverer': '卡尔·舍勒', 'discoveryYear': '1774', 'uses': '消毒剂、塑料、水处理',
             'hazardClass': '有毒', 'casNumber': '7782-50-5', 'description': '氯是一种黄绿色有毒气体，广泛用于消毒和化工生产。',
    ...
    '18Ar': {'name': '氩', 'symbol': 'Ar', 'atomicNumber': 18, 'category': '稀有气体', 'group': 18, 'period': 3,
             ...
             'discoverer': '威廉·拉姆齐', 'discoveryYear': '1894', 'uses': '焊接保护气、照明、激光',
             'hazardClass': '非易燃气体', 'casNumber': '7440-37-1', 'description': '氩是大气中含量第三的气体，约占空气的1%。',
    ...
    '19K': {'name': '钾', 'symbol': 'K', 'atomicNumber': 19, 'category': '碱金属', 'group': 1, 'period': 4,
            ...
            'discoverer': '汉弗莱·戴维', 'discoveryYear': '1807', 'uses': '肥料、玻璃制造、电池',
            'hazardClass': '遇水反应', 'casNumber': '7440-09-7', 'description': '钾是一种银白色金属，与水剧烈反应。',
    ...
    '20Ca': {'name': '钙', 'symbol': 'Ca', 'atomicNumber': 20, 'category': '碱土金属', 'group': 2, 'period': 4,
             ...
             'discoverer': '汉弗莱·戴维', 'discoveryYear': '1808', 'uses': '建筑材料、补钙剂、合金',
             'hazardClass': '无特殊危害', 'casNumber': '7440-70-2', 'description': '钙是人体必需的元素，是骨骼和牙齿的主要成分。',
    ...
    '21Sc': {'name': '钪', 'symbol': 'Sc', 'atomicNumber': 21, 'category': '金属', 'group': 3, 'period': 4,
             ...
             'discoverer': '拉斯·尼尔森', 'discoveryYear': '1879', 'uses': '铝合金、激光材料、催化剂',
             'hazardClass': '无特殊危害', 'casNumber': '7440-20-2', 'description': '钪是一种稀有金属，常用于高强度铝合金。',
    ...
    '22Ti': {'name': '钛', 'symbol': 'Ti', 'atomicNumber': 22, 'category': '金属', 'group': 4, 'period': 4,
             ...
             'discoverer': '威廉·格雷戈尔', 'discoveryYear': '1791', 'uses': '航空航天、医疗植入物、体育用品',
             'hazardClass': '无特殊危害', 'casNumber': '7440-32-6', 'description': '钛是一种轻质高强度金属，具有优异的耐腐蚀性。',
    ...
    '23V': {'name': '钒', 'symbol': 'V', 'atomicNumber': 23, 'category': '金属', 'group': 5, 'period': 4,
            ...
            'discoverer': '安德斯·贝采利乌斯', 'discoveryYear': '1830', 'uses': '合金钢、催化剂、电池',
            'hazardClass': '无特殊危害', 'casNumber': '7440-62-2', 'description': '钒是一种坚硬的金属，用于制造高强度合金。',
    ...
    '24Cr': {'name': '铬', 'symbol': 'Cr', 'atomicNumber': 24, 'category': '金属', 'group': 6, 'period': 4,
             ...
             'discoverer': '路易·沃克兰', 'discoveryYear': '1797', 'uses': '不锈钢、电镀、颜料',
             'hazardClass': '致癌物', 'casNumber': '7440-47-3', 'description': '铬是一种坚硬的银白色金属，常用于电镀和不锈钢。',
    ...
    '25Mn': {'name': '锰', 'symbol': 'Mn', 'atomicNumber': 25, 'category': '金属', 'group': 7, 'period': 4,
             ...
             'discoverer': '约翰·甘恩', 'discoveryYear': '1774', 'uses': '钢铁生产、电池、合金',
             'hazardClass': '氧化剂', 'casNumber': '7439-96-5', 'description': '锰是一种灰白色金属，是钢铁生产的重要原料。',
    ...
    '26Fe': {'name': '铁', 'symbol': 'Fe', 'atomicNumber': 26, 'category': '金属', 'group': 8, 'period': 4,
             ...
             'discoverer': '已知元素', 'discoveryYear': '古代', 'uses': '钢铁、建筑、机械',
             'hazardClass': '无特殊危害', 'casNumber': '7439-89-6', 'description': '铁是地球上最常用的金属，是工业的基础。',
    ...
    '27Co': {'name': '钴', 'symbol': 'Co', 'atomicNumber': 27, 'category': '金属', 'group': 9, 'period': 4,
             ...
             'discoverer': '格奥尔格·布兰特', 'discoveryYear': '1735', 'uses': '电池、合金、催化剂',
             'hazardClass': '无特殊危害', 'casNumber': '7440-48-4', 'description': '钴是一种银白色金属，用于制造高强度合金和电池。',
    ...
    '28Ni': {'name': '镍', 'symbol': 'Ni', 'atomicNumber': 28, 'category': '金属', 'group': 10, 'period': 4,
             ...
             'discoverer': '阿克塞尔·克龙斯泰特', 'discoveryYear': '1751', 'uses': '不锈钢、电池、催化剂',
             'hazardClass': '无特殊危害', 'casNumber': '7440-02-0', 'description': '镍是一种银白色金属，具有良好的耐腐蚀性。',
    ...
    '29Cu': {'name': '铜', 'symbol': 'Cu', 'atomicNumber': 29, 'category': '金属', 'group': 11, 'period': 4,
             ...
             'discoverer': '已知元素', 'discoveryYear': '古代', 'uses': '电线、管道、合金',
             'hazardClass': '无特殊危害', 'casNumber': '7440-50-8', 'description': '铜是一种紫红色金属，具有优异的导电性。',
    ...
    '30Zn': {'name': '锌', 'symbol': 'Zn', 'atomicNumber': 30, 'category': '金属', 'group': 12, 'period': 4,
             ...
             'discoverer': '印度人', 'discoveryYear': '1300年前', 'uses': '镀锌、电池、合金',
             'hazardClass': '无特殊危害', 'casNumber': '7440-66-6', 'description': '锌是一种蓝白色金属，常用于镀锌以防止腐蚀。',
    ...
    '31Ga': {'name': '镓', 'symbol': 'Ga', 'atomicNumber': 31, 'category': '金属', 'group': 13, 'period': 4,
             ...
             'discoverer': '保罗·埃米尔·勒科克·德布瓦博德兰', 'discoveryYear': '1875', 'uses': '半导体、LED、合金',
             'hazardClass': '无特殊危害', 'casNumber': '7440-55-3', 'description': '镓是一种低熔点金属，在手中就可以熔化。',
    ...
    '32Ge': {'name': '锗', 'symbol': 'Ge', 'atomicNumber': 32, 'category': '类金属', 'group': 14, 'period': 4,
             ...
             'discoverer': '克莱门斯·温克勒', 'discoveryYear': '1886', 'uses': '半导体、光纤、红外光学',
             'hazardClass': '无特殊危害', 'casNumber': '7440-56-4', 'description': '锗是一种类金属，曾用于早期半导体器件。',
    ...
    '33As': {'name': '砷', 'symbol': 'As', 'atomicNumber': 33, 'category': '类金属', 'group': 15, 'period': 4,
             ...
             'discoverer': '阿尔伯特·马格努斯', 'discoveryYear': '1250', 'uses': '半导体、农药、木材防腐剂',
    ...
    '34Se': {'name': '硒', 'symbol': 'Se', 'atomicNumber': 34, 'category': '非金属', 'group': 16, 'period': 4,
             ...
             'discoverer': '永斯·贝采利乌斯', 'discoveryYear': '1817', 'uses': '太阳能电池、玻璃着色、半导体',
             'hazardClass': '有毒', 'casNumber': '7782-49-2', 'description': '硒是一种非金属元素，是人体必需的微量元素。',
...
for i in range(35, 119):
    ...
    if idx < len(symbols):
        ...
        # 设置周期
        if i <= 18: period = 1 if i <= 2 else 2 if i <= 10 else 3
        elif i <= 36: period = 4
        elif i <= 54: period = 5
        elif i <= 86: period = 6
        else: period = 7
        
        all_elements[f'{i:03d}{symbol}'] = {
